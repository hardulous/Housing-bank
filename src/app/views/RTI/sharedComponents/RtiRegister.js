      ...
      <Grid container id="mainDiv">
        <Grid style={{ padding: ".5rem 1rem" }} >
          ...
          <Grid container spacing={2}>
            <Grid item xs={3} style={{ width: "100%" }}>
              ...
              <div className="filter-data">
                ...
                >
                  <FormControl component="fieldset" style={{ marginTop: "10px", fontSize: "16px" }} id="rtifilter">
                    ...
                    >
                      ...
                      <FormControlLabel
                        ...
                        onClick={() => handleFilterStatus("Responded and Closed")}
                        // onChange={handleChanges}
                        style={{ color: "green" }}
            ...
            <Grid item xs={9} style={{
              ...
              >
                <div
                  ...
                  id="Rticalender" style={{ width: "100%" }}
                >
                  <ScheduleComponent
                    height={Number(window.innerHeight - 98)}
                  ...
                  <Button id="loader" onClick={handleClickRegister}

                    style={{
                      marginTop: "0.6rem", cursor: "pointer",
                      fontSize: "13px", padding: "0px 2px",
                    }} > {t("REGISTER")} </Button>
                  {/* <Finalreg /> */}
          ...
          <Drawer
            ...
            open={open}
            classes={{
              paper: !open ? classes.drawerPaperNotOpen : classes.drawerPaperOpen
            }}
          >
      ...
      >
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between" }} >
            <Typography style={{ fontSize: "24px", padding: "0.3rem", color: "#0564C8" }}>RTI</Typography>
            <IconButton
