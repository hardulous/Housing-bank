 ...
 const dat = yesterday.toISOString().slice(0,10)
  ...
  const validationSchema = yup.object().shape({
    ...
    dateValdation: yup.string(),
     startDate: yup.date('').when("dateValdation",(started, yup) => started && yup.min(started, "You Cannot select Previous Date "))     
  });
  ...
  return (
    ...
    label="CHAIRMAN"
        ...
        fullWidth
        error={
          formik.touched.chairman &&
          Boolean(formik.errors.chairman)
        }
        helperText={
