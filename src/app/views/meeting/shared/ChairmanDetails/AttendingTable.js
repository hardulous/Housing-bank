...
import "../index.css";
import { Grid, TextField, Button, IconButton, Tooltip, Paper } from "@material-ui/core";
import Dialog from '@material-ui/core/Dialog';
import DialogActions from '@material-ui/core/DialogActions';
import DialogContent from '@material-ui/core/DialogContent';
import DialogTitle from '@material-ui/core/DialogTitle';
import { MeetingId, HandleClosebtn } from "../InboxTableDetails/GetMeetingDetails";
...
console.log(props.meetingID)
  ...
  const getAttendees = useSelector((state) => state.AttendeesReducer.getAttendees);
  ...
  return (
    ...
    <div>
      ...
      <Dialog open={open} onClose={() =>{ handleClose(); formik.handleReset()}}>
        <DialogTitle>ADD ATTENDEE
          <IconButton
            id="attendingTable_close_btn"
            aria-label="close"
            onClick={() =>{ handleClose(); formik.handleReset()}}
            style={{
              float: "right",
              height: "30px",
              width: "30px",
        ...
        <DialogContent style={{ width: "500px" }}>
          <form onSubmit={formik.handleSubmit}>
            ...
            <DialogActions>
              ...
              <Button id="attendingTable_reset_btn" startIcon={<UndoIcon />} variant="outlined" color="primary" onClick={formik.resetForm}>
                Reset
              </Button>
              <Button id="attendingTable_submit_btn" endIcon={<DoneIcon />} color="primary" variant="outlined" type="submit">
                Submit
              </Button>
            </DialogActions>
          </form>
